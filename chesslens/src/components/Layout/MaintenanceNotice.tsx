...
export function MaintenanceNotice({ feature, onClose }: MaintenanceNoticeProps) {
  ...
  return (
    <>
      ...
      />
      {/* Centralização (translate -50%/-50%) fica num wrapper separado da animação de entrada:
          a keyframe de cl-modal-in também anima "transform" e, no mesmo elemento, sobrescreveria
          o translate de centralização assim que a animação terminasse (mesmo bug corrigido em
          SettingsPanel.tsx). */}
