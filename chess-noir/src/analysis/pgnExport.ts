...
/**
 * Mapeamento das categorias do Chess Noir pros NAGs (Numeric Annotation Glyph) padrão da
 * especificação PGN — assim qualquer leitor de PGN (lichess, chess.com, ChessBase...) entende a
 * anotação sem precisar conhecer o Chess Noir. Só os NAGs de "força do lance" (não os de avaliação
