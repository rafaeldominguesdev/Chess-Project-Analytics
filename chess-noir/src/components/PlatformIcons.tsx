...
// sem alterar o traçado nem as cores de marca de nenhum dos dois. Já tinham sido trocados por um
// ícone de sol genérico numa sessão anterior (a pedido do usuário na época), mas o usuário pediu
// de volta os logos reais — "tem que ser o logo deles".
