...
## Próximo checkpoint
- Com as Fases 3 e 4 concluídas e a Fase 6 avançada (Home e "Analisar" como telas separadas, incl. "voltar pra busca com partida carregada"), retomar Fase 8 (responsividade) ou Fase 10 (acessibilidade no resto do app, fora do editor de posição), conforme o usuário priorizar na próxima sessão.
- A `SearchView` (nova tela de "Analisar") ainda não foi testada em telas estreitas — bom candidato pra Fase 8 quando ela for priorizada.
